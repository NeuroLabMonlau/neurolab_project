                    ...
                    @foreach($pendingTests as $pendingTest)
                        <div class="bg-white rounded-lg shadow-md overflow-hidden border-2 border-emerald-300">
                            ...
                            <div class="p-6">
                                ...
                                <a href="{{ route('student.games.play', ['student_id' => $pendingTest->student_id, 'gameTest_id' => $pendingTest->gameTests->id, 'test_id' => $pendingTest->test_id, 'game_id' => $pendingTest->game_id, 'level' => $pendingTest->gameTests->level]) }}" class="mt-4 inline-block bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700" target="_blank">Play</a>
                            </div>
                        </div>
                    @endforeach
                </div>
